/*.$file${./Source::trafficlight.h} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*
...
/*.$declare${Events::TLevt} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${Events::TLevt} ........................................................*/
typedef struct {
/* protected: */
    QEvt super;
...
/*.$declare${AOs::TLtraffic_ctor} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${AOs::TLtraffic_ctor} ..................................................*/
int16_t TLtraffic_ctor(void);
/*.$enddecl${AOs::TLtraffic_ctor} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*.$declare${AOs::AO_TLtraffic[N_TL]} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
extern QActive * const AO_TLtraffic[N_TL];
/*.$enddecl${AOs::AO_TLtraffic[N_TL]} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/

/*.$declare${AOs::TLpedestrian_ctor} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${AOs::TLpedestrian_ctor} ...............................................*/
void TLpedestrian_ctor(void);
/*.$enddecl${AOs::TLpedestrian_ctor} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*.$declare${AOs::AO_TLpedestrian} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
/*.$declare${AOs::TLblinker_ctor} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${AOs::TLblinker_ctor} ..................................................*/
void TLblinker_ctor(void);
/*.$enddecl${AOs::TLblinker_ctor} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*.$declare${AOs::AO_TLblinker} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
