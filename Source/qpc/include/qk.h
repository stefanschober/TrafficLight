...
typedef struct QK_Attr {
    ...
    uint8_t nextPrio;   /*!< QF prio of the next AO to execute */
    uint8_t actThre;    /*!< active preemption-threshold */
    uint8_t lockCeil;   /*!< lock preemption-ceiling (0==no-lock) */
    uint8_t lockHolder; /*!< QF prio of the AO holding the lock */
} QK;
