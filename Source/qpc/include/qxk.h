...
typedef struct QXK_Attr {
    struct QActive *curr; /*!< current thread (NULL=basic) */
    struct QActive *next; /*!< next thread to run */
    struct QActive *prev; /*!< previous thread */
    uint8_t actPrio;      /*!< QF-prio of the active AO */
    uint8_t lockCeil;     /*!< lock-ceiling (0==no-lock) */
    uint8_t lockHolder;   /*!< prio of the lock holder */
} QXK;
